...
User Name = <s:property value="name" />
		<br>
User Address = <s:property value="address" default="USA" />
		<br>
User Address = <s:property value="gender" default="female" />
		<br>
	</s:push>

	<h4>Struts 2 bean tag example</h4>
	<s:bean name="com.struts.model.User" var="myUser">
	...
	<br> MyUser Gender =
	<s:property value="#myUser.gender" />
	<br> MyUser Address =
	<s:property value="#myUser.address" />
	<br> Default Name =
	<s:property value="#myUser.getDefaultName()" />
	<br>

	<h4>Struts 2 action tag example</h4>

	Data from footer action =
	<s:action name="footer" namespace="/" executeResult="true"></s:action>

	<h4>Struts 2 Miscellaneous Data tags example</h4>

	a tag example:
	<s:a href="#top">Go To Top</s:a>
	<s:url action="footer.action" var="urlTag">
	</s:url>
	<s:a href="%{urlTag}" >Google</s:a>


	<br> date tag example:
	<s:date name="user.date" format="MM/dd/yyyy" />
	<br> include tag example:
	<s:include value="/footer.jsp"></s:include>
	<br> text tag example:
	<s:text name="home.title"></s:text>
	<br> i18n tag example:
	<s:i18n name="global">
		<s:text name="home.name"></s:text>
	</s:i18n>
	<br> debug tag example:
	<s:debug></s:debug>
