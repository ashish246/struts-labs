...
<body>
	...
	<s:elseif test="emp.role=='Developer'">
		<strong>User is Developer and id is greater than or equal to
			100.</strong>
	</s:elseif>
	<s:else>
		<strong>User is NOT Developer and id is greater than or equal
			to 100.</strong>
	</s:else>
	<br>
	<br>
	...
	<s:iterator value="emp.citiesList" begin="0" step="1"
		...
		<s:if test="#iteratorStatus.first">First City = <s:property />
			<br>
		</s:if>
		<s:elseif test="#iteratorStatus.last">Last City = <s:property />
		</s:elseif>
		<s:else>City <s:property value="#iteratorStatus.count" /> = <s:property />
			<br>
		</s:else>
	</s:iterator>
	<br>
	<br> Properties Map table is:
	...
	<br>
	<br> Appending Cities and Countries List:
	<br>
	...
	<s:iterator value="#appendedList" status="myListStatus">
		<s:property value="#myListStatus.count" />. <s:property />
		<br>
	</s:iterator>
	<br>
	<br> Merging Cities and Countries List:
	<br>
	...
	<br>
	<br> Sorting Cities List:
	<br>
	<s:bean name="com.struts.actions.StringComparator"
		var="myComparator"></s:bean>
	...
	<br>
	<br> Excluding USA from the countries list:
	<br>
	...
	<br>
	<br> Generate iterator example:
	<br>
	<s:generator val="%{'apple|banana|orange'}" separator="|"
		var="fruitsIterator" />
