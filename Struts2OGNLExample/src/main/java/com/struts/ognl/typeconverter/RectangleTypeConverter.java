package com.struts.ognl.typeconverter;
...
import com.struts.ognl.model.Rectangle;

/**
 * Custom type converter to convert user input to Rectangle Format is R:x,y
 * where x and y are int defining Rectangle dimensions
 * 
 * @author ashish
 *
 */
public class RectangleTypeConverter extends StrutsTypeConverter {
	...
	public Object convertFromString(Map arg0, String[] inputs, Class arg2) {
		...
		if (!input.startsWith("R:"))
			throw new TypeConversionException("invalid input");
