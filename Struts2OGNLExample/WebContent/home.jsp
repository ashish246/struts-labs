...
<body>
	...
	<s:form action="welcome" method="post">
		...
		<strong>Array with same name example</strong>
		<br>
		<table>
		...
		<strong>Array with indexed name example</strong>
		<br>
		<table>
		...
		<strong>List with same name example</strong>
		<br>
		<table>
		...
		<strong>List with indexed name example</strong>
		<br>
		<table>
